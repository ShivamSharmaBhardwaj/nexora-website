      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Convert text into professional PDF documents with templates, styles, and formatting
          </p>
          ...
          <div className="mt-8 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-2xl p-6 text-white text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-cyan-100 mb-4">
                Get unlimited conversions, all templates, advanced styling, and priority support.
              </p>
              <button
                onClick={handleUpgrade}
