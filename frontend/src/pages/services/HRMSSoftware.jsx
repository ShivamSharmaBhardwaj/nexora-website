...
import { FaCheckCircle, FaArrowRight, FaUsers, FaClock, FaChartLine, FaDatabase, FaCrown, FaUserCheck, FaBuilding } from 'react-icons/fa';
...
const HRMSSoftware = () => {
  ...
  document.title = title || 'HRMS Software India | Krynova Technologies';
